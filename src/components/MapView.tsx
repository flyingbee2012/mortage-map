...
export function MapView({ mapRef, mapError }: MapViewProps) {
  return (
    <section className="absolute inset-0 lg:relative lg:inset-auto lg:flex-1 lg:min-h-0 lg:h-full lg:order-last rounded-2xl overflow-hidden bg-neutral-900 shadow-xl">
